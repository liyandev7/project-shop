...
@section('title', 'صفحه اصلی - مدیریت محصول ها ')
    ...
    <div class="content-wrapper">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>ایا از حذف این محصول رضایت دارید ؟</p>
                    </div>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> مدیریت محصول ها</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">خانه</a></li>
                            <li class="breadcrumb-item active">مدیریت محصول ها</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">مدیریت محصول ها</h3>
                    </div>

                    <div class="float-left">
                        <a href="{{ route('products.create') }}" class="btn btn-sm btn-primary">اضافه کردن محصول </a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        @if ($product->slider)
                                            <span class="badge badge-info">هست</span>
                                        @else
                                            <span class="badge badge-danger">نیست</span>
                                        @endif
                                    </td>
                                    <td>{{ $product->price }}</td>
                                    <td>
                                    ...
                                    <td>
                                        {{ \Hekmatinasser\Verta\Verta::instance($product->created_at) }}
                                    </td>
                                    <td>
                                        <a href="{{ route('products.edit', ['product' => $product->id]) }}"
                                            class="btn btn-sm btn-primary">ویرایش</a>
                                        <a onclick="showModal('{{ url('/admin/panel/products' . '/' . $product->id) }}')"

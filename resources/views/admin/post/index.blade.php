...
@section('title', 'صفحه اصلی - مدیریت پست ها ')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>ایا از حذف این پست رضایت دارید ؟</p>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">مدیریت پست ها</h3>
                    </div>

                    <div class="float-left">
                        <a href="{{ route('blogs.create') }}" class="btn btn-sm btn-primary">اضافه کردن پست </a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($blogs as $blog)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('blog.show', ['post' => $blog->id]) }}">
                                            {{ $blog->title }}
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="showModal('{{ url('/admin/panel/blogs' . '/' . $blog->id) }}')"

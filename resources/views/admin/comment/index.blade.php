...
@section('title', 'صفحه اصلی - مدیریت نظر ها ')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>ایا از حذف این نظر رضایت دارید ؟</p>
                    </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">مدیریت نظر ها</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">مدیریت نظر ها</h3>
                    </div>
                        ...
                        <tbody>
                            @foreach ($comments as $comment)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ \Hekmatinasser\Verta\Verta::instance($comment->created_at) }}
                                    </td>
                                    <td>
                                        <a href="{{ route('comments.edit', ['comment' => $comment->id]) }}"
                                            class="btn btn-sm btn-primary">ویرایش</a>
                                        <a onclick="showModal('{{ url('/admin/panel/comments' . '/' . $comment->id) }}')"

...
@section('title', 'صفحه اصلی - مدیریت کاربر ها ')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">مدیریت کاربر ها</h3>
                    </div>

                    <div class="float-left">
                        <a href="{{ route('users.create') }}" class="btn btn-sm btn-primary">اضافه کردن کاربر </a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        @if ($user->sttaf === 0)
                                            <span class="badge badge-danger">بلاک شده</span>
                                        @elseif($user->sttaf === 1)
                                            <span class="badge badge-primary"> کاربر عادی</span>
                                        @elseif($user->sttaf === 2)
                                            <span class="badge badge-secondary"> کاربر مدیر</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="showModal('{{ url('/admin/panel/users' . '/' . $user->id) }}')"

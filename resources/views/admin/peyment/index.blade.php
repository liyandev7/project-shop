...
@section('title', 'صفحه اصلی - مدیریت پرداخت ها ')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>ایا از حذف این پرداخت رضایت دارید ؟</p>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">مدیریت پرداخت ها</h3>
                    </div>
                        ...
                        <tbody>
                            @foreach ($peyments as $peyment)
                                <tr>
                                    ...
                                    <td>{{ $peyment->id }}</td>
                                    <td>{{ $peyment->resnumber }}</td>
                                    <td>{{ $peyment->status ? 'پرداخت شده' : 'پرداخت نشده' }}</td>
                                    <td>
                                        {{ \Hekmatinasser\Verta\Verta::instance($peyment->created_at) }}
                                    </td>

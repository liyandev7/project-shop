...
@section('title', 'صفحه اصلی - مدیریت برند ها ')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>ایا از حذف این برند رضایت دارید ؟</p>
                    </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">مدیریت برند ها</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">مدیریت برند ها</h3>
                    </div>

                    <div class="float-left">
                        <a href="{{ route('brands.create') }}" class="btn btn-sm btn-primary">اضافه کردن برند </a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($brands as $brand)
                                <tr>
                                    ...
                                    <td>{{ $brand->name }}</td>
                                    <td>{{ $brand->url ?? 'وجود ندارد' }}</td>



                                    <td>
                                        {{ \Hekmatinasser\Verta\Verta::instance($brand->created_at) }}
                                    </td>
                                    <td>
                                        <a href="{{ route('brands.edit', ['brand' => $brand->id]) }}"
                                            class="btn btn-sm btn-primary">ویرایش</a>
                                        <a onclick="showModal('{{ url('/admin/panel/brands' . '/' . $brand->id) }}')"

...
@section('title', 'صفحه اصلی - ابدیت کردن برند ')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> ابدیت کردن برند</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">خانه</a></li>
                            <li class="breadcrumb-item active">ابدیت کردن برند</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">ابدیت کردن برند</h3>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('brands.update', ['brand' => $brand->id]) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 m-auto">
                                <div class="form-group">
                                    <label for="">پیش نمایش تصویر : </label>
                                    <img src="{{ asset($brand->image) }}" alt="" class="img-fluid" width="120">
                                </div>
                            </div>

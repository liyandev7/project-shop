...
@section('title','صفحه اصلی - مدیریت استان ها ')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>ایا از حذف این استان رضایت دارید ؟</p>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <h3 class="card-title">مدیریت استان ها</h3>
                    </div>

                    <div class="float-left">
                        <a href="{{route('provinces.create')}}" class="btn btn-sm btn-primary">اضافه کردن استان </a>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                {{\Hekmatinasser\Verta\Verta::instance($province->created_at)}}
                            </td>
                            <td>
                                <a href="{{route('provinces.edit',['province'=>$province->id])}}" class="btn btn-sm btn-primary">ویرایش</a>
                                <a onclick="showModal('{{url('/admin/panel/location/provinces'.'/'.$province->id)}}')" class="btn btn-sm text-white btn-danger">حذف</a>

            ...
            <div class="row">
                <div class="area-content-P404 col-12 d-flex justify-content-center flex-column align-items-center py-5">
                    <h1 class="mb-3 d-flex justify-content-center align-items-center flex-column">
                        ...
                        <span class="text-center d-inline-block text-danger mt-2">خطای کد: 403</span>
                    </h1>
                    <h2 class="title404 mb-2">دسترسی به صفحه مورد نظر ندارید</h2>
                    <p class="mb-4"> اشتباه کردی اومدی اینجا برگردد اینجا حریم خصوصی وب سایت هستش .</p>
                    <div class=" mb-4 pb-2">
